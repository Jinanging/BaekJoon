...
//    각 팀의 참가 선수가 여섯보다 작으면 그 팀은 점수 계산에서 제외됨을 주의하라. 여섯 명 보다 많은 선수가 참가하는 팀은 없고,
...
//    각 테스트 케이스의 첫 번째 줄에는 하나의 정수 N (6 ≤ N ≤ 1,000)이 주어진다. 두 번째 줄에는 팀 번호를 나타내는 N 개의 정수 t1, t2, …, tN 이 공백을 사이에 두고 주어진다. 각 팀은 1 과 M(1 ≤ M ≤ 200)사이의 정수로 표현된다.
//
//    출력
//    출력은 표준출력을 사용한다. 하나의 테스트 케이스에 대한 우승팀의 번호를 한 줄에 출력한다.
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (T-- > 0) {
            ...
            int[] order = new int[201];

            int score = 1; // 유효 선수 기준 점수
            ...
            for (int team = 1; team <= 200; team++) {
                if (count[team] == 6) {
                    if (sum[team] < minSum ||
                            (sum[team] == minSum && fifth[team] < minFifth)) {
